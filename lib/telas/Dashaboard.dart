...
class OptionCard extends StatelessWidget {
  ...
  OptionCard({super.key, required this.icon, required this.title});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // Navegar para a tela correspondente à opção
        // Reproduzir som de clique aqui, se necessário
      },
      child: Card(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
...
List<Option> options = [
  Option(icon: Icons.book, title: 'Concentração'),
  Option(icon: Icons.mood, title: 'Humor'),
  Option(icon: Icons.table_rows, title: 'Ansiedade'),
  Option(icon: Icons.assignment, title: 'Tarefas'),
  Option(icon: Icons.alarm, title: 'Lembretes'),
  Option(icon: Icons.lightbulb, title: 'Dicas'),
